...
@Service
@Transactional
public class CinemaServiceImplt implements ICinemaInitService{
	...
	public void initVilles() {
		Stream.of("Casa","Marak","Khenifra").forEach(nameVille->{
	...
	public void initCinema() {
		villeRepository.findAll().forEach(v->{
			Stream.of("Mega RAMA","IMAX","FOUNOUN").forEach(nameCinema->{
	...
	public void initCategories() {
		Stream.of("Historique","Fiction","Drama").forEach(cat->{
